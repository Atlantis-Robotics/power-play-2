...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public double getVX_WEIGHT() {
        return VX_WEIGHT;
    }

    public void setVX_WEIGHT(double VX_WEIGHT) {
        this.VX_WEIGHT = VX_WEIGHT;
    }

    public double getVY_WEIGHT() {
        return VY_WEIGHT;
    }

    public void setVY_WEIGHT(double VY_WEIGHT) {
        this.VY_WEIGHT = VY_WEIGHT;
    }

    public double getOMEGA_WEIGHT() {
        return OMEGA_WEIGHT;
    }

    public void setOMEGA_WEIGHT(double OMEGA_WEIGHT) {
